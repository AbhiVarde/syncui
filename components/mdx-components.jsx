...
const TextVariants = dynamic(() => import("./ui/components/Texts"));
const LoaderVariants = dynamic(() => import("./ui/components/Loaders"));
const SeparatorVariants = dynamic(() => import("./ui/components/Separators"));
const BackgroundVariants = dynamic(() => import("./ui/components/Backgrounds"));
const AvatarVariants = dynamic(() => import("./ui/components/Avatars"));
const TabVariants = dynamic(() => import("./ui/components/Tabs"));
const PaginationVariants = dynamic(() => import("./ui/components/Paginations"));
const CarouselVariants = dynamic(() => import("./ui/components/Carousels"));
const TableVariants = dynamic(() => import("./ui/components/Tables"));
const DockVariants = dynamic(() => import("./ui/components/Docks"));
const PointerVariants = dynamic(() => import("./ui/components/Pointers"));
const GridVariants = dynamic(() => import("./ui/components/Grids"));
const AccordionVariants = dynamic(() => import("./ui/components/Accordions"));
const TextFieldVariants = dynamic(() => import("./ui/components/TextFields"));
const DialogVariants = dynamic(() => import("./ui/components/Dialogs"));
const FormVariants = dynamic(() => import("./ui/components/Forms"));
const AutocompleteVariants = dynamic(
  () => import("./ui/components/Autocompletes"),
);
const DatePickerVariants = dynamic(() => import("./ui/components/DatePickers"));
const TimePickerVariants = dynamic(() => import("./ui/components/TimePickers"));
const SkeletonVariants = dynamic(() => import("./ui/components/Skeletons"));
const HeroVariants = dynamic(() => import("./ui/blocks/Hero/Hero"));
const CTAVariants = dynamic(() => import("./ui/blocks/CTA/Cta"));
const PricingVariants = dynamic(() => import("./ui/blocks/Pricing/Pricing"));
const StatsVariants = dynamic(() => import("./ui/blocks/Stats/Stats"));
const LineChart = dynamic(() => import("./ui/charts/line"));
const BarChart = dynamic(() => import("./ui/charts/bar"));
const Donut = dynamic(() => import("./ui/charts/donut"));
const Stat = dynamic(() => import("./ui/charts/stat"));
const Progress = dynamic(() => import("./ui/charts/progress"));
const Heatmap = dynamic(() => import("./ui/charts/heatmap"));

---
title: CTA
description: Animated CTA section blocks for React. Use via CLI or copy the code.
---

CTA sections built with Motion. Install via CLI or copy the code into your project.

#### Centered

Centered headline with two action buttons.

<CodePreview
  noPadding 
  preview={<CTAVariants variant="centered" />}
  cli="cta/centered"
  code={`
...
Headline on the left, buttons on the right.

<CodePreview
  noPadding 
  preview={<CTAVariants variant="split" />}
  cli="cta/split"
  code={`
import React from "react";
import {
...
Centered CTA with feature cards below, inspired by [Mintlify](https://mintlify.com).

<CodePreview
  noPadding 
  preview={<CTAVariants variant="grid" />}
  cli="cta/grid"
  code={`
import React from "react";
import {
...
Multi-column layout with feature links, inspired by [Stripe](https://stripe.com).

<CodePreview
  noPadding 
  preview={<CTAVariants variant="columns" />}
  cli="cta/columns"
  code={`
import React from "react";
import {

...
A comprehensive CTA with centered content and additional feature cards below.
...
A multi-column layout showcasing key features with links alongside the main CTA.

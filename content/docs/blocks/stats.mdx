---
title: Stats
description: Animated stats section blocks for React. Use via CLI or copy the code.
---

Stats sections built with Motion. Install via CLI or copy the code into your project.

#### Simple

Large numbers in a row, staggered in on load.
...
Icon badges with numbers and column dividers.

<CodePreview
  noPadding
  preview={<StatsVariants variant="with-icons" />}
  cli="stats/with-icons"
  code={`
import React from "react";
import { Box, Typography, Container, useTheme } from "@mui/material";
import { motion } from "motion/react";
...
Bordered cards with icons, numbers, and descriptions.

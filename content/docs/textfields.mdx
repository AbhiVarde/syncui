...
A responsive OTP input with 6 individual fields, auto-focus navigation, and visual progress indicators.
          ...
          <React.Fragment key={index}>
            ...
            >
              <TextField
                ...
                inputRef={(input) => input?.setAttribute("data-index", index)}
              />
            </motion.div>

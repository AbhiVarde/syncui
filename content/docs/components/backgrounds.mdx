---
title: Backgrounds
description: Animated background components for React. Use via CLI or copy the code.
---

Backgrounds built with Motion. Install via CLI or copy the code into your project.

#### Gemini Wave

Wave-like patterns move across a gradient.

<CodePreview
  preview={<BackgroundVariants variant="geminiWave" />}
  cli="backgrounds/geminiWave"
  code={`
...
Color focal points shift across the gradient.

<CodePreview
  preview={<BackgroundVariants variant="gradientMesh" />}
  cli="backgrounds/gradientMesh"
  code={`
...
Shapes drift across a gradient background.

<CodePreview
  preview={<BackgroundVariants variant="movingShapes" />}
  cli="backgrounds/movingShapes"
  code={`
...
Squares flicker at random.

<CodePreview
  preview={<BackgroundVariants variant="flickeringGrid" />}
  cli="backgrounds/flickeringGrid"
  code={`
import React, { useMemo } from "react";
...
Squares highlight on hover.

<CodePreview
  preview={<BackgroundVariants variant="interactiveGrid" />}
  cli="backgrounds/interactiveGrid"
  code={`
...
Simple grid line pattern.

<CodePreview
  preview={<BackgroundVariants variant="grid" />}
  cli="backgrounds/grid"
  code={`
import React from "react";
import { Box, Typography, useTheme } from "@mui/material";
import { motion } from "motion/react";
...
Dots connect to the cursor with lines.

<CodePreview
  preview={<BackgroundVariants variant="magneticConnections" />}
  cli="backgrounds/magneticConnections"
  code={`

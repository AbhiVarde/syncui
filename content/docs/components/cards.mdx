---
title: Cards
description: Animated card components for React. Use via CLI or copy the code.
---

Cards built with Motion. Install via CLI or copy the code into your project.

#### Lens

Magnifying lens follows the cursor on hover.
...
Images auto-scroll in a smooth carousel.

<CodePreview
  preview={<CardVariants variant="twitterCarousel" />}
  cli="cards/twitterCarousel"
  code={`
...
Meteors streak across the background.

<CodePreview
  preview={<CardVariants variant="meteorShower" />}
  cli="cards/meteorShower"
  code={`
import React, { useState, useEffect } from "react";
...
Image overlay transitions on hover.

<CodePreview
  preview={<CardVariants variant="dynamicOverlay" />}
  cli="cards/dynamicOverlay"
  code={`
...
Image shifts on hover above a content layout.

<CodePreview
  preview={<CardVariants variant="contentCard" />}
  cli="cards/contentCard"
  code={`
import React from "react";
import { Card, CardContent, Typography, Box, Button } from "@mui/material";
import { motion } from "motion/react";
...
Gradient border rotates around the card.

<CodePreview
  preview={<CardVariants variant="animatedBorder" />}
  cli="cards/animatedBorder"
  code={`
import React from "react";
import { Card, CardContent, Typography, Box, useTheme } from "@mui/material";
import { motion } from "motion/react";

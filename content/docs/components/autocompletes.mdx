---
title: Autocompletes
description: Autocomplete components for React. Use via CLI or copy the code.
---
...
<CodePreview
  ...
  cli="autocompletes/multi-select"
  code={`
import React, { useState, useRef } from "react";
import { motion, AnimatePresence } from "motion/react";
import { Typography, useTheme, Box } from "@mui/material";
...
<CodePreview
  ...
  cli="autocompletes/custom-render"
  code={`
import React, { useState, useRef } from "react";
import { motion, AnimatePresence } from "motion/react";
import { Typography, useTheme, Box } from "@mui/material";

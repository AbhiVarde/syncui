---
title: Date Pickers
description: Date picker components for React. Use via CLI or copy the code.
---
...
const SingleDatePicker = () => {
  ...
  return (
    <Box sx={{ width: "100% !important", maxWidth: "320px !important", margin: "0 auto !important", position: "relative !important" }}>
...
<CodePreview
  overflowVisible={true}
  preview={<DatePickerVariants variant="range" />}
  cli="datepickers/range"
  code={`import React, { useState, useMemo } from "react";
import { Typography, useTheme, Box, TextField, InputAdornment, IconButton } from "@mui/material";
import {
  LuCalendar,
...
<CodePreview
  overflowVisible={true}
  preview={<DatePickerVariants variant="presets" />}
  cli="datepickers/presets"
  code={`import React, { useState, useMemo } from "react";
    ...
    return {
      ...
      backgroundColor: \`\${isStart || isEnd
        ...
        ? isDark
          ...
          : "rgba(0,0,0,0.06)"
        : "transparent"} !important\`,
      border: \`\${isCurrentDay && !isStart && !isEnd
        ? \`1px solid \${isDark ? "#666" : "#999"}\`
        : "1px solid transparent"} !important\`,
      transition: "all 0.15s ease !important",
    };
...
export default PresetsDatePicker;
`}
/>
...
<CodePreview
  overflowVisible={true}
  preview={<DatePickerVariants variant="with-time" />}
  cli="datepickers/with-time"
  code={`import React, { useState, useMemo } from "react";
import { Typography, useTheme, Box, TextField, Button, InputAdornment, IconButton } from "@mui/material";
import {
  LuCalendar,
          ...
          >
            ...
            {selectedDate && (
              ...
              >
                ...
                />
                <Typography sx={{ color: \`\${isDark ? "#666" : "#999"} !important\`, fontSize: "12px !important" }}>
                  :
                </Typography>
                <TextField

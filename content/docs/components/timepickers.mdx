---
title: Time Pickers
description: Animated time picker components for React. Use via CLI or copy the code.
---
...
export default TimePickerWithSeconds;`}
/>
